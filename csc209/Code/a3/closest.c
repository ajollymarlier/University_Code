...
int main(int argc, char **argv) {
    ...
    if (argc != 5){ //TODO should this be 3 from starter code?????
        print_usage();
    }
    ...
    while((opt = getopt(argc, argv, "d:f:")) != -1){
        ...
        {
        case 'd':
            pdepth = strtol(optarg, NULL, 10); //IGNORE optarg flag //TODO addstrtol error checking
            break;
        
        case 'f':
            filename = optarg; //IGNORE optarg flag
            break;
